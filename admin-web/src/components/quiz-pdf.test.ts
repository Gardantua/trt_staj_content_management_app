...
describe("buildQuizPdfModel", () => {
  it("includes content identity, quiz number and marked correct answers", () => {
    const model = buildQuizPdfModel(
      { id: "content-1", title: "Örnek Dizi", description: "İçerik", watchUrl: null, contentType: "SERIES", publicationStatus: "PUBLISHED", coverMediaId: "media-1", coverImageUrl: "/media/1", coverAlternativeText: "Kapak", seasons: [], createdAt: "", updatedAt: "" },
